                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-footer-widget">
                            ...
                            <ul class="quick-links">
                                ...
                                <li>
                                    <a href="#"><i class='bx bxs-chevrons-right'></i>Contact Us</a>
                                </li>
                                <li>
                                    <a href="#"><i class='bx bxs-chevrons-right'></i>Gulf cars</a>
                                </li>
                                <li>
                                    <a href="#"><i class='bx bxs-chevrons-right'></i>Incoming cars</a>
                                </li>
                                <li>
                                    <a href="#"><i class='bx bxs-chevrons-right'></i>Car shows</a>
                                </li>
                            </ul>
                        </div>
                    </div>
