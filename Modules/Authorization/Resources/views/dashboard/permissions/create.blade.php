                                                ...
                                                <ul style="list-style-type:none">
                                                    <li style="list-style-type:none">
                                                        <label class="mt-checkbox">
                                                            <input class="child" type="checkbox" name="permission[]" value="add">
                                                    ...
                                                    <li style="list-style-type:none">
                                                        <label class="mt-checkbox">
                                                            <input class="child" type="checkbox" name="permission[]" value="edit">
                                                    ...
                                                    <li style="list-style-type:none">
                                                        <label class="mt-checkbox">
                                                            <input class="child" type="checkbox" name="permission[]" value="delete">
                                                    ...
                                                    <li style="list-style-type:none">
                                                        <label class="mt-checkbox">
                                                            <input class="child" type="checkbox" name="permission[]" value="show">
