        ...
        <div class="page-content">
            ...
            <div class="row">
                <form id="updateForm" role="form" class="form-horizontal form-row-seperated" method="post"
                      enctype="multipart/form-data" action="{{route('dashboard.roles.update',$role->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                        <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="name" placeholder="add_user"
                                                       class="form-control" data-name="name" value="{{ $role->name }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="display_name[{{$code}}]"
                                                           ...
                                                           value="{{ $role->getTranslation('display_name',$code)}}">
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        @endforeach
