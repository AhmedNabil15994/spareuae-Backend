                ...
                <div class="portlet light bordered">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ url(route('dashboard.categories.create')) }}" class="btn sbold green">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select class="form-control" id="categoryType" name="type" data-name="type">
                                                                    <option value="{{null}}">@lang("apps::frontend.home.all")</option>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{__('category::dashboard.categories.datatable.type')}}</th>
...
<script>
    function tableGenerate(data='') {
      var protectedCategory = @json(setting('protected_cat') ?? []);
          ...
          columnDefs: [
            {
      				...
      				render: function(data, type, full, meta) {
                          if(protectedCategory.includes(`${data}`)){
                              return "-----"
                          }
                        //   console.log(protectedCategory.includes(data), data, protectedCategory)
