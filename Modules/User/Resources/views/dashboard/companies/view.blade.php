...
@section('title', __('user::dashboard.companies.routes.show'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('user::dashboard.companies.routes.show')}}</a>
                </li>
            </ul>
        </div>
                            ...
                            @if($user->type == "company" && $user->company)
                                <li class="">
                                    ...
                                    <a data-toggle="tab" href="#company">
                                        <i class="fa fa-cog"></i> {{ __('user::dashboard.companies.form.company') }}
                                    </a>
                                    <span class="after"></span>
                                </li>
                            @endif
                                            ...
                                            <table class="table table-bordered ">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ $company->country->translateOrDefault(locale())->title }}
                                                        </td>
                                                    </tr>
                                                    @endif
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ $company->city->translateOrDefault(locale())->title }}
                                                        </td>
                                                    </tr>
                                                    @endif
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ $company->state->translateOrDefault(locale())->title }}
                                                        </td>
                                                    </tr>
                                                    @endif
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr >
                                                                                <td colspan="2"> 
                                                                                    ...
                                                                                    <form style="display: inline-block" method="POST" action="{{route('dashboard.companies.renwal', $user->id)}}">
                                                                                        @csrf
                                                                                        <button type="submit" class="btn btn-info">{{__('user::dashboard.users.datatable.currentSubscription.renewal')}}</button>
                                                                                    </form>
                                                                                    @endif
                                                                                    <a href="{{route('dashboard.companies.edit', $user->id)}}" class="btn btn-sm blue" title="Edit">
