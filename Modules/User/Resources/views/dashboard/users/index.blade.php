    ...
    <div class="row">
      <div class="col-md-12">
        <div class="portlet light bordered">
                      ...
                      <div class="form-body">
                        <div class="row">
                          ...
                          {{-- <div class="col-md-2">
                            <div class="form-group">
                              <label class="control-label">
                                {{__('user::dashboard.users.datatable.type')}}</ </label>
                                <div class="">
                                  <select class="form-control" name="type">
                                    <option value="">{{__('apps::dashboard.datatable.all')}}</option>
                                    @foreach (setting("customs.users") as $type )
            ...
            <table class="table table-striped table-bordered table-hover" id="dataTable">
              <thead>
                <tr>
                  ...
                  <th>{{__('user::dashboard.users.datatable.status')}}</th>
                  <th>{{__('user::dashboard.users.datatable.type')}}</th>
          ...
          <div class="row">
            <div class="form-group">
              <button type="submit" id="deleteChecked" class="btn red btn-sm" onclick="deleteAllChecked('{{ url(route('dashboard.users.deletes')) }}')">
          ...
          columns: [
            ...
            {data: 'email' 	          , className: 'dt-center'},
                  ...
                  {data: 'type' 	        , className: 'dt-center',  render: function(data, type, row){
                        if(data == "user")
                          return '<span class="badge badge-success"> {{__('user::dashboard.users.datatable.user')}} </span>';
                        return '<span class="badge badge-info"> {{__('user::dashboard.users.datatable.show')}} </span>';
                    }},
