                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.admins.create.form.name')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.admins.create.form.email')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.admins.create.form.mobile')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.admins.create.form.password')}}
                                        </label>
                                        <div class="col-md-9">
                                            <input type="password"
                                            autocomplete="new-password"
                                            name="password" class="form-control" data-name="password">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.admins.create.form.confirm_password')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.admins.create.form.image')}}
                                        </label>
                                        <div class="col-md-9">
