                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.admins.update.form.name')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.admins.update.form.email')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.admins.update.form.mobile')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.admins.update.form.password')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.admins.update.form.confirm_password')}}
                                        </label>
                                        <div class="col-md-9">
                                        ...
                                        <div class="col-md-9">
                                            <div class="mt-checkbox-list">
                                                ...
                                                <label class="mt-checkbox">
                                                    ...
                                                    {{$role->translateOrDefault(locale())}}
                                                    <span></span>
                                                </label>
                                                @endforeach
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::dashboard.admins.update.form.image')}}
                                        </label>
                                        <div class="col-md-9">
                                            ...
                                            <span class="holder" style="margin-top:15px;max-height:100px;">
                                                <img src="{{$user->image ? url($user->image) : ''}}" style="height: 15rem;">
                                            </span>
