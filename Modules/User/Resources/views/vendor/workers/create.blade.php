...
@section('title', __('user::vendor.workers.create.title'))
@section('css')
    <style>
        .display-none{
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('user::vendor.workers.create.title')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="form" role="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('vendor.workers.store')}}">
                @csrf
...
{{--
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::vendor.workers.create.form.country')}}
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2">
                                            {{__('user::vendor.workers.create.form.password')}}
                                        </label>
                                        <div class="col-md-9">
                            ...
                            <div class="tab-pane fade in" id="worker">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="hidden" name="vendor_id" value="{{auth()->user()->workerProfile->vendor_id}}"  id="vendors" />
                                    {{-- <div class="form-group">
                                        <label class="col-md-2">
