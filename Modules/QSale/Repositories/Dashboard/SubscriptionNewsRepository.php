...
use Modules\Apps\Entities\NewsSubscriptions  as Model;

class SubscriptionNewsRepository
{
    ...
    {
        $models = Cache::rememberForever('news_subscriptions', function ()  use($order, $sort)
        {
    ...
    public function delete($id)
    {
        ...
        try {
            ...
            DB::commit();
            Cache::forget("news_subscriptions");
            return true;
        } catch (\Exception $e) {
            DB::rollback();
            throw $e;
