...
use Modules\QSale\Entities\AdType  as Model;
...
class AdTypeRepository
{
    ...
    {
        $models = Cache::rememberForever('ad_types', function () use ($order, $sort) {
    ...
    public function create($request)
    {
        ...
        try {
            ...
            $icon = $request->icon ? pathFileInStroage($request, "icon", "ad_types") : "/uploads/default.png";
    ...
    public function update($request, $id)
    {
        ...
        if ($request->icon) {
            ...
            $icon = pathFileInStroage($request, "icon", "ad_types");
        }
