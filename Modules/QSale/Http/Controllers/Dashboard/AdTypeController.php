...
use Modules\QSale\Http\Requests\Dashboard\AdTypeRequest as ModelRequest;
use Modules\QSale\Repositories\Dashboard\AdTypeRepository as Repo ;
use Modules\QSale\Transformers\Dashboard\AdTypeResource as ModelResource;
...
class AdTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('qsale::dashboard.ad_types.index');
    }
    ...
    public function create()
    {
        ...
        return view('qsale::dashboard.ad_types.create');
    }
    ...
    {
        return view('qsale::dashboard.ad_types.show');
    }

    public function edit($id)
    {
        $model = $this->repo->findById($id);
        return view('qsale::dashboard.ad_types.edit',compact('model'));
    }
