...
@section('title', __('qsale::dashboard.coupons.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('qsale::dashboard.coupons.routes.index')}}</a>
                </li>
            </ul>
        </div>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ url(route('dashboard.coupons.create')) }}" class="btn sbold green">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('qsale::dashboard.coupons.datatable.code')}}</th>
                                    <th>{{__('qsale::dashboard.coupons.datatable.status')}}</th>
                                    <th>{{__('qsale::dashboard.coupons.datatable.expired_at')}}</th>
                                    <th>{{__('qsale::dashboard.coupons.datatable.amount')}}</th>
                                    <th>{{__('qsale::dashboard.coupons.datatable.is_fixed')}}</th>
                                    <th>{{__('qsale::dashboard.coupons.datatable.current_use')}}</th>
                                    <th>{{__('qsale::dashboard.coupons.datatable.created_at')}}</th>
                                    <th>{{__('qsale::dashboard.coupons.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
...
<script>
 ...
 responsivePriority:1,
              width: '13%',
              title: '{{__('qsale::dashboard.coupons.datatable.options')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {
