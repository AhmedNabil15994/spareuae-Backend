...
@section('title', __('qsale::dashboard.packages.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('qsale::dashboard.packages.routes.index')}}</a>
                </li>
            </ul>
        </div>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ url(route('dashboard.packages.create')) }}" class="btn sbold green">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('qsale::dashboard.packages.datatable.title')}}</th>
                                    <th>{{__('qsale::dashboard.packages.datatable.description')}}</th>
                                    <th>{{__('qsale::dashboard.packages.datatable.price')}}</th>
                                    <th>{{__('qsale::dashboard.packages.datatable.duration')}}</th>
                                    <th>{{__('qsale::dashboard.packages.datatable.number_of_ads')}}</th>
                                    <th>{{__('qsale::dashboard.packages.datatable.is_free')}}</th>
                                    <th>{{__('qsale::dashboard.packages.datatable.status')}}</th>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                onclick="deleteAllChecked('{{ url(route('dashboard.packages.deletes')) }}')">
...
<script>
    function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ajax : {
              url   : "{{ url(route('dashboard.packages.datatable')) }}",
              type  : "GET",
              data  : {
                  req : data,
              },
          ...
          columns: [
            ...
            {data: 'number_of_ads' 	        , className: 'dt-center'},
 ...
 responsivePriority:1,
              ...
              render: function(data, type, full, meta) {
                ...
                // Edit
      					var editUrl = '{{ route("dashboard.packages.edit", ":id") }}';
      					editUrl = editUrl.replace(':id', data);

      					// Delete
      					var deleteUrl = '{{ route("dashboard.packages.destroy", ":id") }}';
