...
@section('title', __('qsale::dashboard.republished_packages.routes.update'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('qsale::dashboard.republished_packages.routes.update')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('dashboard.republished_packages.update',$model->id)}}">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                                ...
                                <div class="tab-pane active fade in" id="general">
                                    ...
                                    <div class="col-md-10">
                                            ...
                                            @foreach (config('translatable.locales') as $code)
                                                <div id="first_{{$code}}" class="tab-pane fade @if($loop->first) in active @endif">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="title[{{$code}}]" value="{{$model->translate('title', $code)}}" class="form-control" data-name="title.{{$code}}">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="checkbox" class="make-switch" {{ $model->is_free ? "checked" : ""}}  id="is_free" value="1" data-size="small" name="is_free">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="price" value="{{$model->price}}" id="price" class="form-control " data-name="price">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" name="duration" value="{{$model->duration}}" class="form-control " data-name="duration">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
