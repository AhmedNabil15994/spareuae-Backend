...
@section('title', __('qsale::dashboard.addations.routes.create'))
@section('content')
  ...
  <div class="page-content">
    <div class="page-bar">
      <ul class="page-breadcrumb">
        ...
        <li>
          <a href="#">{{ __('qsale::dashboard.addations.routes.create') }}</a>
        </li>
      </ul>
    </div>
    ...
    <div class="row">
      <form id="form"
        ...
        action="{{ route('dashboard.addations.store') }}">
        @csrf
        <div class="col-md-12">
          {{-- RIGHT SIDE --}}
          <div class="col-md-3">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <select class="form-control select2"
                        ...
                        <option value="{{ $type }}"> {{
                          __('qsale::dashboard.addations.form.types.' . $type) }}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  ...
                  {{-- <div class="form-group">
                    ...
                    <div class="col-md-9">
                      ...
                      <select class="form-control"
                        ...
                        <option data-url="{{ Modules\User\Enums\UserType::routeSelect2($type) }}"
                          value="{{ $type }}">
