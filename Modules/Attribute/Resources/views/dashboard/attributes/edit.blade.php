...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="row">
            <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('dashboard.attributes.update',$model->id)}}">
                @csrf
                @method('PUT')
                            ...
                            <div class="tab-pane active fade in" id="general">
                                ...
                                <div class="col-md-10">
                                        ...
                                        @foreach (config('translatable.locales') as $code)
                                            <div id="first_{{$code}}" class="tab-pane fade @if($loop->first) in active @endif">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" value="{{$model->translate('name', $code)}}" name="name[{{$code}}]" class="form-control" data-name="name.{{$code}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" name="sort" class="form-control" data-name="sort" value="{{$model->sort}}">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <span class="holder" style="margin-top:15px;max-height:100px;">
                                                <img src="{{$model->icon ? url($model->icon) : ''}}" style="height: 15rem;">
                                    ...
                                    <div class="form-group hidden"  ref="loadingHidden" v-if="allowSetOptions">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            @include("attribute::dashboard.attributes.components.nested-related-options")
                                            ...
                                            <div id="loading-wait" >
                                                ...
                                                <table class="table table-responsive">
                                                    ...
                                                    <tbody>
                                                        {{-- old options --}}
                                                        <tr v-for="(option, index) in old_options" :key="'edit_add' + index ">
                                                            <template v-for="code of lang" >
                                                                <td>
                                                                    <template v-if="editIndexElment == index && editOption != null && typeOfEdit == 'edit' ">
                                                                        <input  type="text" :class="{invalid:code in editOption.value && editOption.value[code].length <=0}" v-model="editOption.value[code]"/>
                                                                        <input  type="hidden" class="from-controll" :value="option.value[code]" :name="`edit_option[${index}][value][${code}]`" />
                                                                    </template>
                                                                    <template v-else>
                                                            ...
                                                            <td>
                                                              <template v-if="editIndexElment == index && editOption != null && typeOfEdit == 'edit' " type="text" :class="{invalid:editOption.parent_id.length <=0}" v-model="editOption.parent_id">
                                                                <select data-target="#relative_options" class="form-control parent_id" data-toggle="select2" :value="option.parent_id" :name="`edit_option[${index}][parent_id]`"  v-model="option.parent_id" onchange="getOptionsById(this)">
                                                                  <option value=""></option>
                                                              ...
                                                              <template v-else>
                                                                <span style="margin:0">@{{ option.parent !== null && option.parent.hasOwnProperty('name') ? option.parent.name[this.locale] : option.parent }}</span>
                                                                <input  type="hidden" class="from-controll" :value="option.parent_id" :name="`edit_option[${index}][parent_id]`" />
                                                              </template>

                                                            </td>
                                                            <td id="relative_options">
                                                              <template v-if="editIndexElment == index && editOption != null && typeOfEdit == 'edit' " type="text" :class="{invalid:editOption.related_options.length <=0}" v-model="editOption.related_options">
                                                                <select  class="form-control related_options" data-toggle="select2" :value="option.related_options" :name="`edit_option[${index}][related_options]`" v-model="option.related_options"  multiple>
                                                                  <option value=""></option>
                                                                </select>
                                                              </template>

                                                              <template v-else>
                                                                <span style="margin:0"  v-for="(item, itemIndex) in option.related">@{{ item.hasOwnProperty('value') ? item.value[this.locale] : item }}<br></span>
                                                                <input type="hidden" class="from-control" :value="option.related_options" :name="`edit_option[${index}][related_options]`" />
                                                              </template>

                                                            </td>
                                                            <td>
                                                                <input type="checkbox" v-model="option.status"  :value="option.status" :name="`edit_option[${index}][status]`" />
                                                                <input type="hidden" v-model="option.id"   :name="`edit_option[${index}][id]`" />
                                                                <input class="hidden" type="checkbox" v-model="option.status"  :value="option.is_default" :name="`edit_option[${index}][is_default]`" />
                                                            </td>
                                                            <td>
                                                                    <template v-if="editIndexElment == index && editOption != null && typeOfEdit == 'edit'">
                                                                        <button class="btn btn-warning" :data-related="option.related_options" :data-target="option.parent_id" @click.prevent="saveEditOption()"><i class="fa fa-check-square" aria-hidden="true"></i></button>
                                                                        <button class="btn btn-danger" @click.prevent="cancleEditOption()"><i class="fa fa-times" aria-hidden="true"></i></button>
                                                                    </template>
                                                                    <template v-else>
                                                                        <button class="btn btn-warning" :data-related="option.related_options" :data-target="option.parent_id" @click.prevent="editOptionData(index, 'edit')"><i class="fa fa-pencil" aria-hidden="true"></i></button>
                                                                        <button class="btn btn-danger" @click.prevent="removeOldOption(index)"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                                                    </template>
                                                            </td>
                                                        ...
                                                        <tr v-for="(option, index) in options" :key="'option_add' + index ">
                                                            <template v-for="code of lang" >
                                                                <td>
                                                                    <template v-if="editIndexElment == index && editOption != null &&  typeOfEdit == 'new' ">
                                                                        <input  type="text" :class="{invalid:editOption[code].length <=0}" v-model="editOption[code]"/>
                                                            ...
                                                            <td>
                                                              <template v-if="editIndexElment == index && editOption != null && typeOfEdit == 'new'" type="text" :class="{invalid:editOption.parent_id.length <=0}" v-model="editOption.parent_id">
                                                            ...
                                                            <td id="relative_options">
                                                              <template v-if="editIndexElment == index && editOption != null && typeOfEdit == 'new'" type="text" :class="{invalid:editOption.related_options.length <=0}" v-model="editOption.related_options">
                                                            ...
                                                            <td>
                                                                ...
                                                                <template v-else>
                                                                    <button class="btn btn-warning" :data-related="option.related_options" :data-target="option.parent_id" @click.prevent="editOptionData(index)"><i class="fa fa-pencil" aria-hidden="true"></i></button>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <select class="form-control type" v-model="option_default"  v-on:change="setDefault()" >
                                                                                <option v-for="(option, index)  in old_options" :value="'edit_'+index":key="'edit_'+index" >
                                                                                    @{{option.value.hasOwnProperty(locale) ? option.value[locale] : ''}}
                                                                                </option>
                                    ...
                                    <div class="hidden" v-if="deleteOptions.length > 0">
                                      <input type="hidden" name="deleteOptions[]" v-for="objectDelete in deleteOptions" :key="`delete_${objectDelete.id}`" v-model="objectDelete.id" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="checkbox" class="make-switch" @if($model->status) checked @endif id="test" data-size="small" name="status">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" v-show="allowValidationNumber == true">
                                        ...
                                        <div class="col-md-9">
                                            <input type="checkbox" class="make-switch"  @if($model->allow_from_to) checked @endif id="test" data-size="small" name="allow_from_to">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="checkbox" class="make-switch" @if($model->show_in_search) checked @endif  id="test2" data-size="small" name="show_in_search">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane  fade in" id="validation">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="checkbox" class="make-switch" @if($validations->get("required") == 1) checked @endif  id="test" data-size="small" name="validation[required]" value="1">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div v-show="allowValidationNumber == true">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="">
                                                            <input type="text" :disabled="!allowValidationNumber" value="{{$validations->get('min')}}"  name="validation[min]" placeholder="  {{__('attribute::dashboard.attributes.form.validation.min')}}"  class="form-control " data-name="validation.min">
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="">
                                                            <input type="text" :disabled="!allowValidationNumber" value="{{$validations->get('max')}}" name="validation[max]" placeholder="  {{__('attribute::dashboard.attributes.form.validation.max')}}"  class="form-control " data-name="validation.max">
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-5">
                                                                <input type="checkbox" @if($validations->get("validate_min") == 1) checked @endif :disabled="!allowValidationNumber" class=""  id="test" data-size="small" name="validation[validate_min]" value="1">
                                                                <div class="help-block"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-5">
                                                                <input type="checkbox" @if($validations->get("validate_max") == 1) checked @endif :disabled="!allowValidationNumber" class=""  id="test" data-size="small" name="validation[validate_max]" value="1">
                                                                <div class="help-block"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="checkbox" class=""  @if($validations->get("is_int") == 1) checked @endif:disabled="!allowValidationNumber" id="test" data-size="small" name="validation[is_int]" value="1">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>
                                    </div>
  ...
  <script src="https://cdn.jsdelivr.net/npm/vue@2.6.12/dist/vue.js"></script>
    ...
    <script>
        ...
        $(function(){
            ...
            $(document).on('click','tr .btn.btn-warning',function () {
        ...
        var vm = new Vue({
            ...
            methods: {
                ...
                editOptionData:function(index, type="new"){
                    ...
                    let currentOption = type == "new" ? this.options[index] : this.old_options[index];
                    if(type == 'new'){
                    ...
                    this.editOption =  JSON.parse(JSON.stringify({...currentOption}))
