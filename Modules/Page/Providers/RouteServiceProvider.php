...
class RouteServiceProvider extends ServiceProvider
{
    ...
    protected function mapDashboardRoutes()
    {
        ...
        ->namespace($this->dashboardModule)->group(module_path('Page', 'Routes/dashboard/routes.php'));
    }
    ...
    protected function mapWebRoutes()
    {
        ...
        ->namespace($this->frontendModule)->group(module_path('Page', 'Routes/frontend/routes.php'));
    }

    protected function mapApiRoutes()
    {
        Route::group(['prefix'=>'api' ,'middleware' => ['api'] , 'namespace' => $this->apiModule], module_path('Page', 'Routes/api/routes.php'));
    }
}
