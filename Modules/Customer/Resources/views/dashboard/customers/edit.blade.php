...
@section('title', __('customer::dashboard.customers.routes.update'))
@section('content')
    ...
    <div class="page-content">
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li>
            <a href="#">{{ __('customer::dashboard.customers.routes.update') }}</a>
          </li>
        </ul>
      </div>
      ...
      <div class="row">
        {!! Form::model($model, [
    'url' => route('dashboard.customers.update', $model->id),
    'id' => 'updateForm',
    'role' => 'form',
    'page' => 'form',
