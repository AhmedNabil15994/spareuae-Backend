            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        <li>
                            @can("edit_users")
                            <a href="{{ url(route('dashboard.users.edit',auth()->id())) }}">
                                <i class="icon-user"></i>{{ __('apps::dashboard._layout.navbar.profile') }} </a>
                            @endcan
                        </li>
                        <li>
                            <a href="#" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                <i class="icon-key"></i> {{ __('apps::dashboard._layout.navbar.logout') }}
                            </a>
