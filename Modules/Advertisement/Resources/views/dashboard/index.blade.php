...
@section('title', __('advertisement::dashboard.advertisement.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('advertisement::dashboard.advertisement.routes.index')}}</a>
                </li>
            </ul>
        </div>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ url(route('dashboard.advertisement.create')) }}" class="btn sbold green">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('advertisement::dashboard.advertisement.datatable.image')}}</th>
                                    <th>{{__('advertisement::dashboard.advertisement.datatable.status')}}</th>
                                    <th>{{__('advertisement::dashboard.advertisement.datatable.start_at')}}</th>
                                    <th>{{__('advertisement::dashboard.advertisement.datatable.end_at')}}</th>
                                    <th>{{__('advertisement::dashboard.advertisement.datatable.created_at')}}</th>
                                    <th>{{__('advertisement::dashboard.advertisement.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                onclick="deleteAllChecked('{{ url(route('dashboard.advertisement.deletes')) }}')">
...
<script>
    function tableGenerate(data='') {
      ...
      $('#dataTable').DataTable({
          ...
          ajax : {
              url   : "{{ url(route('dashboard.advertisement.datatable')) }}",
              type  : "GET",
              data  : {
                  req : data,
              },
 ...
 responsivePriority:1,
              width: '13%',
              title: '{{__('advertisement::dashboard.advertisement.datatable.options')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {

                // Edit
      					var editUrl = '{{ route("dashboard.advertisement.edit", ":id") }}';
      					editUrl = editUrl.replace(':id', data);

      					// Delete
      					var deleteUrl = '{{ route("dashboard.advertisement.destroy", ":id") }}';
