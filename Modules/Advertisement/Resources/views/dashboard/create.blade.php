...
@section('title', __('advertisement::dashboard.advertisement.routes.create'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('advertisement::dashboard.advertisement.routes.create')}}</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <form id="form" role="form" class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data" action="{{route('dashboard.advertisement.store')}}">
                @csrf
                <div class="col-md-12">
                            ...
                            <div class="tab-pane active fade in" id="general">
                                ...
                                <div class="col-md-10">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control" name="type" id="type_advertising" data-name="type">
                                                    @foreach (["in", "out"] as $item)
                                                            <option value="{{$item}}">  {{ __("advertisement::dashboard.advertisement.form.$item") }}</option>
                                                    @endforeach
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="checkbox" class="make-switch" checked value="1" id="test" data-size="small" name="status">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
